...
CHARTS = {
    'eth_earnings_rate': {
        'options': ['eth.earnings_rate', 'Ethereum_Earnings_Rate', 'gwei_per_hour', 'earnings', 'eth.earnings_rate', 'line'],
        'lines': [
...
def main():
    ...
    print("DIMENSION earnings_monitor earnings_monitor absolute 1 1")
